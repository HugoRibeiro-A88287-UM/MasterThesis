...
\newacronym{dmi}{DMI}{Direct Memory Interface}
\newacronym{fft}{FFT}{Fast Fourier Transform}
\newacronym{fifo}{FIFO}{First-In First-Out}
\newacronym{fpc}{FPC}{Forecasted Program Counter}
...
\newacronym{ifp}{IFP}{Instruction Flow Prediction}
