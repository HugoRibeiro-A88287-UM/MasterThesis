...
In conclusion, par-gem5 with both static and dynamic versions will be tested with the developed interface. The previous tests, which were all done 
in the sequential mode, will be the reference for these. The main objective is to determine which approach is better in the different situations.
