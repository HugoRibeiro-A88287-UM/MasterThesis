...
Each simulator will perform different tasks, meaning they will operate at different abstraction levels. For this reason, the remote interface is 
...
\textit{TLM\_WRITE} have some differences. First of all, instead of sending the frame, it receives it and verifies if the received slot is accessible.
